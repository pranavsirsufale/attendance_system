      ...
      {isAdmin && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <Link to="/admin/teachers" className="text-blue-600 hover:underline">View/Edit Teachers</Link>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-2 text-gray-800">Manage Students</h3>
            <Link to="/admin/students" className="text-blue-600 hover:underline">View/Edit Students</Link>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-2 text-gray-800">Manage Programs</h3>
            <Link to="/admin/programs" className="text-blue-600 hover:underline">View/Edit Programs</Link>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-2 text-gray-800">Manage Subjects</h3>
            <Link to="/admin/subjects" className="text-blue-600 hover:underline">View/Edit Subjects</Link>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-2 text-gray-800">Manage Timetables</h3>
            <Link to="/timetable" className="text-blue-600 hover:underline">Create Timetable</Link>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-2 text-gray-800">Manage Sessions</h3>
            <Link to="/admin/sessions" className="text-blue-600 hover:underline">View/Edit Sessions</Link>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-2 text-gray-800">View All Stats</h3>
            <Link to="/admin/attendance-stats" className="text-blue-600 hover:underline">View Attendance Stats</Link>
          </div>
        </div>
      )}
    </div>
