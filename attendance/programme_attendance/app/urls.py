...
urlpatterns = [
    ...
    path('admin/student-search/', views.AdminStudentSearchView.as_view(), name='admin-student-search'),
    ...
    path('admin/section-semester-wise/', views.SectionSemesterWiseDataView.as_view(), name='section-semester-wise'),
