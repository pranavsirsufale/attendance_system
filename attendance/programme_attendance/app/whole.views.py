...
from .models import Attendance, Session, Section, Program, Subject, Teacher, Student, Timetable, CalendarException
from .serializers import (
    AttendanceStatsSerializer, SessionSerializer, AttendanceSerializer, TimetableCreateSerializer,
    TeacherSerializer, StudentSerializer, TimetableSerializer, CalendarExceptionSerializer,
    ProgramSerializer, SubjectSerializer, SectionSerializer, AdminTeacherSerializer,
    AdminStudentSerializer, AdminTimetableSerializer
)
...
class AdminAttendanceStatsView(APIView):
    ...
    def get(self, request):
        ...
        stats = (
            ...
            .annotate(
                name=F('student__first_name') + ' ' + F('student__last_name'),
                ...
                recorded_by=F('recorded_by__first_name') + ' ' + F('recorded_by__last_name'),
        ...
        for section in sections:
            ...
            for student in students:
                for subject in student.subjects.all():
                    ...
                    if serialized not in section_data[sem]:
...
class TimetableViewSet(viewsets.ModelViewSet):
    ...
    def update(self, request, *args, **kwargs):
        instance = self.get_object()
        serializer = TimetableSerializer(instance, data=request.data, partial=True)
        serializer.is_valid(raise_exception=True)
        self.perform_update(serializer)
    ...
    def get(self, request, roll_number):
        try:
            ...
            monthly_stats = Attendance.objects.filter(
                ...
                select={'month': "EXTRACT(MONTH FROM session__date)"}
