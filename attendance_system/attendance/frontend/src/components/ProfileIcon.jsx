      ...
      <AnimatePresence>
        {showDropdown && (
          <motion.div
            ...
            className="absolute right-0 mt-3 w-80 bg-white dark:bg-gray-700  shadow-2xl border border-indigo-100 dark:border-gray-700 p-6 text-gray-800 dark:text-gray-200 z-50"
          >
            {error ? (
              <motion.p
